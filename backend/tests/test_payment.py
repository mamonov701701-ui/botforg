...
def test_create_payment():
    ...
    res = client.post("/payments/", json=payment_data, headers={"Authorization": auth_header})
...
def test_get_payment():
    ...
    create_res = client.post("/payments/", json=payment_data, headers={"Authorization": auth_header})
