...
7. Запускает **Playwright** E2E из `frontend/tests/e2e/` (smoke.spec.ts, auth.spec.ts), скриншоты в `screens/`, отчёт в `playwright_report.txt`, API-вызовы в `ui_api_calls.json`, консоль в `console_log.txt`.
