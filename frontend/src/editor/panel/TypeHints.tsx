...
> = {
  ...
  action: {
    ...
    examples: ['Сохранение', 'Отправка email'],
  },
  condition: {
    title: 'Условие',
    description: ['Разветвление по правилу'],
    examples: ['Если ответ "Да/Нет"', 'Проверка флага'],
  },
  api: {
    title: 'Запрос к API',
    description: ['Интеграция с внешним сервисом'],
