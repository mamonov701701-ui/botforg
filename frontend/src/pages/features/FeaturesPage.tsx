          ...
          <div className="space-y-8 text-[var(--text-muted)] max-w-3xl">
            <section>
              ...
              <ol className="list-decimal pl-5 space-y-3 leading-relaxed">
                ...
                <li>
                  Если нужна развилка, поставьте блок «Условие» и заранее сохраните переменную (блок
                  «Переменная» или ввод текста), которую условие будет проверять.
                </li>
                <li>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm leading-relaxed">
                ...
                запросить ответ, сделать паузу, проверить условие или перейти в другой сценарий. Так
                на схеме в редакторе сценариев складывается логика чат-бота без кода, и с первого
                взгляда понятно, как работает бот от входа пользователя до цели.
              </p>
              <p className="text-sm leading-relaxed">
