import { LayoutDashboard, Settings2, Workflow, BarChart3, FileStack, Rocket } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      <section className="max-w-screen-xl mx-auto px-4 py-16 flex flex-col items-center justify-center">
        <div
          className="rounded-xl p-10 w-full flex flex-col items-center justify-center text-center text-white"
          style={{ backgroundColor: 'rgba(26, 34, 56, 0.25)' }}
        >
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl">
            Выберите шаблон, настройте блоки в редакторе и начните автоматизировать свой бизнес уже
            сегодня.
          </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-8 text-white text-center px-4 py-20 max-w-6xl mx-auto">
        <div
          className="p-6 rounded-xl hover:scale-105 hover:shadow-xl transition text-center"
          style={{ backgroundColor: 'rgba(26, 34, 56, 0.25)' }}
        >
      ...
      <section className="max-w-screen-xl mx-auto px-4 py-16">
        <div
          className="rounded-xl p-10 flex flex-col md:flex-row items-center justify-between gap-12"
          style={{ backgroundColor: 'rgba(26, 34, 56, 0.25)' }}
        >
          <div className="flex-1 text-white text-center md:text-left">
            ...
            <p className="mb-8 text-gray-300 text-lg max-w-xl">
              Перетаскивайте блоки, связывайте сценарии, подключайте оплату и интеграции — всё через
              понятный интерфейс.
            </p>
            <button className="bg-yellow-400 text-black font-semibold py-4 px-8 rounded-full hover:bg-yellow-300 shadow-xl transition transform hover:scale-105 text-lg">
              Попробовать
          ...
          <div className="flex-1 flex justify-center">
            <div
              className="mx-auto rounded-2xl shadow-2xl w-full max-w-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center"
              style={{ height: '400px' }}
            >
