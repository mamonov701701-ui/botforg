    ...
    <div className="min-h-screen bg-white text-gray-900 font-['Roboto']">
      ...
      <header className="flex items-center justify-between px-8 py-4 border-b bg-white">
        ...
        <nav className="flex gap-6 items-center text-sm">
          ...
          <Link
            href="/register"
            className="ml-4 px-5 py-2 rounded bg-yellow-400 text-blue-900 font-bold hover:bg-yellow-300 transition"
          >
            Начать бесплатно
          </Link>
        </nav>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-8 py-16 max-w-6xl mx-auto gap-12">
        <div className="flex-1">
          <h1 className="text-4xl md:text-5xl font-bold font-['Poppins'] text-blue-900 mb-4">
            BotForg — Технологии в действии
          </h1>
          <div className="text-lg text-gray-700 mb-8">
            Создавайте чат-ботов с оплатой, аналитикой и шаблонами без кода
          </div>
          <div className="flex gap-4 mb-8">
            <Link
              href="/register"
              className="px-6 py-3 rounded bg-yellow-400 text-blue-900 font-bold text-lg hover:bg-yellow-300 transition"
            >
              Создать бота
            </Link>
            <Link
              href="/demo"
              className="px-6 py-3 rounded border border-blue-900 text-blue-900 font-bold text-lg hover:bg-blue-50 transition"
            >
              Смотреть демо
            </Link>
          </div>
        ...
        <div className="flex-1 flex justify-center">
          <img
            src="/static/editor-mockup.png"
            alt="Редактор BotForg"
      ...
      <section id="features" className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-2xl font-bold font-['Poppins'] text-blue-900 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-gray-600 text-sm">
                Создавайте логику бота без кода — drag&drop, блоки, условия, интеграции.
              </div>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-4xl mb-2">💬</span>
              ...
              <div className="text-gray-600 text-sm">
                Запускайте ботов в популярных мессенджерах. Поддержка оплат, кнопок, медиа.
              </div>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-4xl mb-2">🛒</span>
              ...
              <div className="text-gray-600 text-sm">
                Быстрый старт с готовыми решениями. Витрина, копирование, монетизация.
              </div>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-4xl mb-2">🔗</span>
              ...
              <div className="text-gray-600 text-sm">
                Подключайте платежи, внешние сервисы, получайте аналитику по сценариям.
              </div>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-4xl mb-2">🎁</span>
              ...
              <div className="text-gray-600 text-sm">
                Делитесь шаблонами, получайте бонусы за приглашения и покупки по вашим ссылкам.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 max-w-6xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            ...
            <div className="text-gray-600 text-sm">
              Выберите готовый сценарий или начните с нуля
            </div>
          </div>
          <div>
            <div className="text-4xl mb-2">🤖</div>
          ...
          <div>
            ...
            <div className="text-gray-600 text-sm">
              Монетизируйте сценарии, отслеживайте результаты
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            />
            <img
              src="/static/marketplace-mockup.png"
              alt="Витрина шаблонов"
              className="rounded-xl shadow border"
            />
            <img
              src="/static/analytics-mockup.png"
              alt="Аналитика"
              className="rounded-xl shadow border"
            />
            <img
              src="/static/telegram-mockup.png"
              alt="Telegram-бот"
              className="rounded-xl shadow border"
            />
          </div>
      ...
      <section id="pricing" className="py-16 max-w-6xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="border rounded-xl p-6 bg-white shadow flex flex-col items-center">
            ...
            <Link
              href="/register"
              className="mt-auto px-4 py-2 rounded bg-yellow-400 text-blue-900 font-bold hover:bg-yellow-300 transition"
            >
              Начать
            </Link>
          </div>
      ...
      <section className="py-16 max-w-4xl mx-auto px-8">
        ...
        <div className="text-gray-500 text-center italic">
          Отзывы скоро появятся — присоединяйтесь к первым пользователям!
        </div>
      </section>

      {/* CTA */}
      <section className="py-16 bg-yellow-400 text-center">
        <h2 className="text-3xl font-bold font-['Poppins'] text-blue-900 mb-4">
          Начни свой первый сценарий уже сегодня
        </h2>
        <Link
          href="/register"
          className="px-8 py-4 rounded bg-blue-900 text-yellow-400 font-bold text-lg hover:bg-blue-800 transition"
        >
          Создать бесплатно
        </Link>
      </section>
